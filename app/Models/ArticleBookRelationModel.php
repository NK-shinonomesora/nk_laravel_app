...
class ArticleBookRelationModel extends BaseModel {
    ...
    {
        return DB::insert(sprintf("INSERT INTO %s (parentId, childId, articleId, bookId, memberId) VALUES (:parentId, :childId, :articleId, :bookId, :memberId)", $this->_tableName), $_data);
    }
